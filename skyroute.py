...
def get_start():
  ...
  if start_point_letter in landmark_choices.keys():
    ...
    print("Sorry, that is not a landmark we have data on. Let's try this again...")
    get_start()

def get_end():
  end_point_letter = input("Ok, Where are you headed? Type in the corresponding letter: ").lower()
